...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Rishit!</span> I'm a passionate and innovative{" "}
      ...
      >
        ...
        <a
          className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer border border-black/10 dark:text-white/60"
          href="https://www.linkedin.com/in/rishit-srivastava-60293a1b4/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/rishitsrivastava"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
